 ...
 */
package l3s.de.ranking_algo_category.relatedness;
...
import l3s.de.ranking_algo_category.VirtuosoConnector;
...
public class RelatednessScore {
	public Map<String, Double> relatedness_score(String[] entityArray, String fromDate, String toDate,
			String timePeriod, int counter) throws FileNotFoundException {
...
//        PrintWriter writer = new PrintWriter("./results/" + counter + "/ranking_relatedness" + counter + ".csv");
...
//        writer.close();
		...
		return Ranked_Article_RelatednessScore_Map;
	}
