...
import static timeliness.ImportanceScoreP.loadXMLFromString;
...
public class TimelinessScore{
    public void timeliness_score(String[] entityArray, String fromDate, String toDate, Map<String, Double> impscore_map, String timePeriod) throws FileNotFoundException{
