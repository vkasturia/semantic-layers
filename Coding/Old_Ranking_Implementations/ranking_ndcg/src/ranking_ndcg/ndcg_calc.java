 ...
 * 
 * Program to Calculate NDCG for all ranking files and store output in a CSV File
 */
...
public class ndcg_calc {
   public static void main(String[] args) throws FileNotFoundException, IOException{
       ...
       if (directoryListing != null) {
           ...
           PrintWriter writer = new PrintWriter("./NDCG_Output.csv");
           outputLine += "NDCG";
           ...
           for (int y = 0; y < 4; y++) {
               ...
               for (List<Double> CurrentList : DCG_ListofLists) {
                   String c = ", " + (CurrentList.get(y) / IDCG_List.get(y));                   
                   outputLine += c;
               }
               outputLine += "\n";
           }
