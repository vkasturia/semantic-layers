...
public class RelatednessScore {
    public Map<String, Double> relatedness_score(String[] entityArray, String fromDate, String toDate, String timePeriod, int counter, Map<String, Map<String, Double>> relEntity_timePeriod_relEntityProximityScoreInPeriod_map) throws FileNotFoundException{
